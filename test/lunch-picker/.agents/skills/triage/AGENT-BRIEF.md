...
- **Good:** "Issues with the tracker value mapped from canonical `needs-triage` appear in the triage attention bucket after initial classification"
...
**Issue category:** bug / enhancement
...
**Current behavior:**
When a feature request is rejected, the issue front matter `status` is set to `wontfix`
...
- Missing required triage disclaimer
