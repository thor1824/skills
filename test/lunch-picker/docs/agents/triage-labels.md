...
The skills speak in terms of seven canonical issue states. This file maps those states to the actual front matter `status` strings used in this repo's markdown issue files.
...
| `ready-for-human` | `ready-for-human` | Requires human action: PRDs are approved for `/to-issues`; issues require human implementation |
