...
See the [engineering skills flowchart](../../docs/plans/FLOWCHART.md) for a quick map of the
main idea-to-ship flow, its on-ramps, and the phase-boundary decision tree.
